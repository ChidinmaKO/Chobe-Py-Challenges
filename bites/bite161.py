...
def count_dirs_and_files(directory='.'):
    ...
    """
    # number_of_directories = sum([len(dirnames) for _, dirnames, _ in os.walk(directory)])
    # number_of_files = sum([len(filenames) for _, _, filenames in os.walk(directory)])
    # return (number_of_directories, number_of_files)
      
    # OR  
    number_of_directories = number_of_files = 0
